...
tienes las siguientes tools disponibles:
- book_appointment: agendar una cita médica en una fecha y hora en específico, para un paciente y un doctor específicos
- get_appointment_availability: verificar disponibilidad de citas
